  ...
  return (
    <main className="organization-onboarding">
      <section className="organization-onboarding__story">
        ...
        <div>
          <p className="organization-onboarding__lead">
            Every supplier, quotation, comparison, and award will belong to an organization—not to a
            shared global pool.
          </p>
      ...
      <section className="organization-onboarding__panel">
        <div className="organization-onboarding__heading">
          ...
          <p>
            Start with the organization that owns the procurement records. You can manage its
            identity and review role permissions in Settings.
          </p>
        </div>
